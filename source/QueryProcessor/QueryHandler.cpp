	...
	while (true) {
		...
		if (queryST->getSynonym() != "") {
			...
			if (ST == "Modifies") {
				...
				else if (modVec.size() > 0 && modVec.front() != "true") {
			...
			if (ST == "Parent") {
				...
				else if (parVec.size() > 0 && parVec.front() != "true") {
			...
			if (ST == "Uses") {
				...
				else if (useVec.size() > 0 && useVec.front() != "true") {
			...
			if (ST == "Next") {
				...
				else if (nextVec.size() > 0 && nextVec.front() != "true") {
